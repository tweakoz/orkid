...
using component_ptr_t = std::shared_ptr<ComponentBase>;
class ScreenInteractivePrivate;
class ScreenInteractive;
using screeninteractive_ptr_t = std::shared_ptr<ScreenInteractive>;
...
class ScreenInteractive : public Screen {
 ...
 private:
  ...
  bool HasQuitted();
  void RunOnce(component_ptr_t component);
  void RunOnceBlocking(component_ptr_t component);

  void HandleTask(component_ptr_t component, Task& task);
  void Draw(component_ptr_t component);
