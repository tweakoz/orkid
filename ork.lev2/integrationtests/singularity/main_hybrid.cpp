...
int main(int argc, char** argv) {
  ...
  auto make_dco = [&](int dcochannel) {
    ...
    // setup LFO
    //////////////////////////////////////
    float rate1    = 0.5 + float(rand() % 100) * 0.05;
    float rate2    = 0.5 + float(rand() % 100) * 0.05;
    ...
    czoscdata->_dcoBaseWaveA = rand() & 0x7;
    czoscdata->_dcoBaseWaveB = rand() & 0x7;
    czoscdata->_dcoWindow    = rand() % 3;
    //////////////////////////////////////
  ...
  // modstage->appendTypedBlock<SUM2>();
  //////////////////////////////////////
