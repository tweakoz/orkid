...
void pyinit_gfx_particles(py::module& module_lev2) {
 ...
 type_codec->registerStdCodec<ptc::basematerial_ptr_t>(mtl_base_type);
  ...
  auto moduledata_type = //
      py::class_<ptc::ModuleData, dflow::DgModuleData, ptc::moduledata_ptr_t>(ptc_module, "Module", py::module_local() )
  ...
  auto ptcmoduledata_type = //
      py::class_<ptc::ParticleModuleData, ptc::ModuleData, ptc::ptcmoduledata_ptr_t>(ptc_module, "ParticleModule", py::module_local());
  type_codec->registerStdCodec<ptc::ptcmoduledata_ptr_t>(ptcmoduledata_type);
  /////////////////////////////////////////////////////////////////////////////
  auto globmoduledata_type = //
      py::class_<ptc::GlobalModuleData, ptc::ModuleData, ptc::globalmodule_ptr_t>(ptc_module, "Globals", py::module_local())
  ...
  auto poolmoduledata_type = //
      py::class_<ptc::ParticlePoolData, ptc::ModuleData, ptc::poolmodule_ptr_t>(ptc_module, "Pool", py::module_local())
  ...
  auto nzlmoduledata_type = //
      py::class_<ptc::NozzleEmitterData, ptc::ModuleData, ptc::nozzleemittermodule_ptr_t>(ptc_module, "NozzleEmitter", py::module_local())
  ...
  auto ringmoduledata_type = //
      py::class_<ptc::RingEmitterData, ptc::ModuleData, ptc::ringemittermodule_ptr_t>(ptc_module, "RingEmitter", py::module_local())
  ...
  auto linemitmoduledata_type = //
      py::class_<ptc::LineEmitterData, ptc::ModuleData, ptc::lineemittermodule_ptr_t>(ptc_module, "LineEmitter", py::module_local())
  ...
  auto eliemitmoduledata_type = //
      py::class_<ptc::EllipticalEmitterData, ptc::ModuleData, ptc::ellipticalemittermodule_ptr_t>(ptc_module, "EllipticalEmitter", py::module_local())
  ...
  auto grvmoduledata_type = //
      py::class_<ptc::GravityModuleData, ptc::ModuleData, ptc::gravitymodule_ptr_t>(ptc_module, "Gravity", py::module_local())
  ...
  auto sphamoduledata_type = //
      py::class_<ptc::SphAttractorModuleData, ptc::ModuleData, ptc::sphattractormodule_ptr_t>(ptc_module, "SphAttractor", py::module_local())
  ...
  auto ellimoduledata_type = //
      py::class_<ptc::EllipticalAttractorModuleData, ptc::ModuleData, ptc::eliattractormodule_ptr_t>(ptc_module, "EllipticalAttractor", py::module_local())
  ...
  auto pntattrmoduledata_type = //
      py::class_<ptc::PointAttractorModuleData, ptc::ModuleData, ptc::pntattractormodule_ptr_t>(ptc_module, "PointAttractor", py::module_local())
  ...
  auto turbmoduledata_type = //
      py::class_<ptc::TurbulenceModuleData, ptc::ModuleData, ptc::turbulencemodule_ptr_t>(ptc_module, "Turbulence", py::module_local())
  ...
  auto vortmoduledata_type = //
      py::class_<ptc::VortexModuleData, ptc::ModuleData, ptc::vortexmodule_ptr_t>(ptc_module, "Vortex", py::module_local())
  ...
  auto dragmoduledata_type = //
      py::class_<ptc::DragModuleData, ptc::ModuleData, ptc::dragmodule_ptr_t>(ptc_module, "Drag", py::module_local())
  ...
  auto lightmoduledata_type = //
      py::class_<ptc::LightRendererData, ptc::ModuleData, ptc::lightmodule_ptr_t>(ptc_module, "LightRenderer", py::module_local())
  ...
  auto spritemoduledata_type = //
      py::class_<ptc::SpriteRendererData, ptc::ModuleData, ptc::spritemodule_ptr_t>(ptc_module, "SpriteRenderer", py::module_local())
  ...
  auto streakmoduledata_type = //
      py::class_<ptc::StreakRendererData, ptc::ModuleData, ptc::streakmodule_ptr_t>(ptc_module, "StreakRenderer", py::module_local())
