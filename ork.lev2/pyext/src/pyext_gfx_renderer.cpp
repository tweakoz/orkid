  ...
  auto cammatstype = //
      py::class_<CameraMatrices, cameramatrices_ptr_t>(module_lev2, "CameraMatrices")
          ...
          .def(
              ...
              [](cameramatrices_ptr_t cammats, fvec2 v2d) -> py::tuple { //
                fvec3 vdir, vori;
                cammats->projectDepthRay(v2d, vdir, vori);
                py::tuple rval = py::make_tuple(vdir, vori);
                return rval;
              })
          .def_property_readonly("V", [](cameramatrices_ptr_t cammats) -> fmtx4 { return cammats->GetVMatrix(); })
          .def_property_readonly("P", [](cameramatrices_ptr_t cammats) -> fmtx4 { return cammats->GetPMatrix(); })
          ...
          .def_property_readonly("IVP", [](cameramatrices_ptr_t cammats) -> fmtx4 { return cammats->GetIVPMatrix(); })
