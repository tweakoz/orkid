...
class ParticlesApp(object):
  ...
  def onGpuInit(self,ctx):
    ...
    self.SPRI.material = particles.GradientMaterial.createShared()
    self.SPRI.material.modulation_texture = Texture.load("src://effect_textures/knob2")
    gradient = GradientV4()
    ...
    self.SPRI.material.gradient = gradient
    self.SPRI.material.blending = tokens.ADDITIVE
