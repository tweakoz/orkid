...
near1 = dplane(0, 0, 1,-0.01)
far1 = dplane(-0, -0, -1,10.0005)
left1  = dplane(0.558692, 0, 0.829375,-0)
right1  = dplane(-0.558692, 0, 0.829375,-0)
top1  = dplane(0, 0.58111, 0.813825,-9.53674e-07)
bottom1  = dplane(0, -0.58111, 0.813825,-9.31323e-10)
################################################################################
...
near2  = dplane(0,0,1,-0.01)
far2  = dplane(-0,-0,-1,10.0005)
left2  = dplane(0.558692,0,0.829375,-0)
right2  = dplane(-0.558692,0,0.829375,-0)
