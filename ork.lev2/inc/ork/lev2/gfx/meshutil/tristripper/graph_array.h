...
typedef typename arc_list_t::iterator		out_arc_iterator;
typedef typename arc_list_t::const_iterator	const_out_arc_iterator;
...
template <class nodetype, class arctype>
inline out_arc_iterator graph_array<nodetype, arctype>::insert_arc(const nodeid & Initial, const nodeid & Terminal) {
	return (insert(begin() + Initial, begin() + Terminal));
}


template <class nodetype, class arctype>
inline out_arc_iterator graph_array<nodetype, arctype>::insert_arc(const nodeid & Initial, const nodeid & Terminal, const arctype & Elem) {
	return (insert(begin() + Initial, begin() + Terminal, Elem));
}


template <class nodetype, class arctype>
inline out_arc_iterator graph_array<nodetype, arctype>::insert_arc(const node_iterator & Initial, const node_iterator & Terminal) {
	++m_NbArcs;
...
template <class nodetype, class arctype>
inline out_arc_iterator graph_array<nodetype, arctype>::insert_arc(const node_iterator & Initial, const node_iterator & Terminal, const arctype & Elem) {
	++m_NbArcs;
