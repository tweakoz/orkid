...
public:
  ...
  static CVtxBuffer<SVtxV12C4T16>& GetConeVB(void) {
    return GetRef().mVtxBuf_Cone;
  }
  static CVtxBuffer<SVtxV12C4T16>& GetGridVB(void) {
    return GetRef().mVtxBuf_GridX100;
  }
  static CVtxBuffer<SVtxV12C4T16>& GetGroundVB(void) {
    return GetRef().mVtxBuf_GroundPlane;
  }
  static CVtxBuffer<SVtxV12N12B12T8C4>& GetPerlinVB(void) {
    return GetRef().mVtxBuf_PerlinTerrain;
  }
  static CVtxBuffer<SVtxV12C4T16>& GetTriCircleVB(void) {
    return GetRef().mVtxBuf_TriCircle;
  }
  static CVtxBuffer<SVtxV12C4T16>& GetDiamondVB(void) {
    return GetRef().mVtxBuf_Diamond;
  }
  static CVtxBuffer<SVtxV12C4T16>& GetCircleStripVB(void) {
    return GetRef().mVtxBuf_CircleStrip;
  }
  static CVtxBuffer<SVtxV12C4T16>& GetCircleStripUI(void) {
    return GetRef().mVtxBuf_CircleStripUI;
  }
  static CVtxBuffer<SVtxV12C4T16>& GetCircleUI(void) {
  ...
  static CVtxBuffer<SVtxV12C4T16>& GetEQSphere(void) {
    return GetRef().mVtxBuf_EQSphere;
  }
  static CVtxBuffer<SVtxV12C4T16>& GetFullSphere(void) {
    return GetRef().mVtxBuf_FullSphere;
  }
