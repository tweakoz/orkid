...
#ifndef _GFX_KERNEL_H
#define _GFX_KERNEL_H
...
struct FontDesc
{
	...
	FontDesc() : miCellWidth(0), miCellHeight(0), miCharWidth(0), miCharHeight(0), miCharOffsetX(0), miCharOffsetY(0), miYShift(0), miAdvanceWidth(0), miAdvanceHeight(0) {}
};
...
class CFontMan : public NoRttiSingleton< CFontMan >
{
	...
	static CFont *GetCurrentFont( void )
	{
