  ...
  if (conplugA && conplugB) {
    struct AA16RenderCells : public AA16Render {
      virtual void DoRender(float left, float right, float top, float bot, Buffer& buf) {
        ...
        RenderQuad(&mtl, mPTX.GetTarget(), 0.0f, 0.0f, 1.0f, 1.0f, u0, v0, u1, v1);

        mPTX.GetTarget()->MTXI()->PopPMatrix();
        mPTX.GetTarget()->PopModColor();
      }
      lev2::GfxMaterial3DSolid mtl;
      AA16RenderCells(ProcTex& ptex, Buffer& bo, const ImgOutPlug* cpa, const ImgOutPlug* cpb)
          : AA16Render(ptex, bo)
        ...
        mtl._rasterstate.SetBlending(ork::lev2::BlendingMacro::OFF);
...
void SphMap::compute(ProcTex& ptex) {
  ...
  if (conplugA && conplugB) {
    struct AA16RenderSphMap : public AA16Render {
      ...
      lev2::GfxMaterial3DSolid mtl;
      AA16RenderSphMap(ProcTex& ptex, Buffer& bo, const ImgOutPlug* cpa, const ImgOutPlug* cpb, float direc)
          : AA16Render(ptex, bo)
        ...
        mtl._rasterstate.SetBlending(lev2::BlendingMacro::OFF);
    ...
    AA16RenderSphMap renderer(ptex, buffer, conplugA, conplugB, mPlugInpDirectionality.GetValue());
    renderer.Render(mbAA);
  }
  MarkClean();
  // buffer.mHash = testhash;
...
void SphRefract::compute(ProcTex& ptex) {
  ...
  if (conplugA && conplugB) {
    struct AA16RenderRefr : public AA16Render {
      ...
      lev2::GfxMaterial3DSolid mtl;
      AA16RenderRefr(ProcTex& ptex, Buffer& bo, const ImgOutPlug* cpa, const ImgOutPlug* cpb, float direc, float ior)
          : AA16Render(ptex, bo)
    ...
    AA16RenderRefr renderer(ptex, buffer, conplugA, conplugB, mPlugInpDirectionality.GetValue(), mPlugInpIOR.GetValue());
    renderer.Render(mbAA);
  }
  MarkClean();
  // buffer.mHash = testhash;
      ...
      mVW.Lock(targ, &mVertexBuffer, 128);
      {
        ...
        switch (meMode) {
          case KaledMode::SQU4: {
            ...
            addvtx(0.0f, 0.0f, fu0, fv0);
            addvtx(0.5f, 0.5f, fu1, fv1);
            addvtx(0.0f, 0.5f, fu0, fv1);
            addvtx(1.0f, 0.0f, fu0, fv0);
            addvtx(0.5f, 0.0f, fu1, fv0);
            addvtx(0.5f, 0.5f, fu1, fv1);
            addvtx(1.0f, 0.0f, fu0, fv0);
            addvtx(0.5f, 0.5f, fu1, fv1);
            addvtx(1.0f, 0.5f, fu0, fv1);
            addvtx(0.0f, 1.0f, fu0, fv0);
            addvtx(0.5f, 1.0f, fu1, fv0);
            addvtx(0.5f, 0.5f, fu1, fv1);
            addvtx(0.0f, 1.0f, fu0, fv0);
            addvtx(0.5f, 0.5f, fu1, fv1);
            addvtx(0.0f, 0.5f, fu0, fv1);
            addvtx(1.0f, 1.0f, fu0, fv0);
            addvtx(0.5f, 1.0f, fu1, fv0);
            addvtx(0.5f, 0.5f, fu1, fv1);
            addvtx(1.0f, 1.0f, fu0, fv0);
            addvtx(0.5f, 0.5f, fu1, fv1);
