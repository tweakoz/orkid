...
struct ComputeInterface : public lev2::ComputeInterface {
  ...
  orksl::PipelineCompute* _currentComputePipeline = nullptr;
  ...
  orksl::PipelineCompute* createComputePipe(orksl::ComputeShader* csh);
  void bindComputeShader(orksl::ComputeShader* csh);
};
#endif
