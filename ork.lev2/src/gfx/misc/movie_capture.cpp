...
bool MovieCaptureContext::encodeFrame(AVFrame* frame) // returns if encoded stream end reached
{
...
/////////////////////////////////////////////////////////////////////////////////////////
void MovieCaptureContext::writeFrame(captureasync_ptr_t capbuf) {
  ...
  OrkAssert(false); // needs reimplentation
/*
  ...
  sws_scale(_swscontext, _rgb_pic->data, _rgb_pic->linesize, 0, _height, _yuv_pic->data, _yuv_pic->linesize);
...
void MovieCaptureContext::init(int width, int height) {
