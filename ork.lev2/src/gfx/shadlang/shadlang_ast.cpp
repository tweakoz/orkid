...
void InheritanceTracker::_processNode(astnode_ptr_t node) {
  ...
  if (auto as_lib = std::dynamic_pointer_cast<SemaInheritLibrary>(node)) {
    ...
    if(0)printf("_processNode LIB<%s>\n", INHID.c_str());
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    auto INHID = as_typ->typedValueForKey<std::string>("inherit_id").value();
    auto it    = _set_inherited_typs.find(INHID);
    if(0)printf("_processNode TYP<%s>\n", INHID.c_str());
    if (it == _set_inherited_typs.end()) {
      _set_inherited_typs.insert(INHID);
      auto TYP = _translation_unit->find<TypeBlock>(INHID);
      OrkAssert(TYP);
      _inherited_types.push_back(TYP);
      if (_onInheritTypes) {
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    if(0)printf("_processNode inheritance VIF<%s>\n", INHID.c_str());
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    auto it    = _set_inherited_interfaces.find(INHID);
    if(0)printf("_processNode inheritance GIF<%s>\n", INHID.c_str());
    if (it == _set_inherited_interfaces.end()) {
      _set_inherited_interfaces.insert(INHID);
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    auto it    = _set_inherited_interfaces.find(INHID);
    if(0)printf("_processNode inheritance FIF<%s>\n", INHID.c_str());
    if (it == _set_inherited_interfaces.end()) {
      _set_inherited_interfaces.insert(INHID);
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    auto it    = _set_inherited_interfaces.find(INHID);
    if(0)printf("_processNode inheritance CIF<%s>\n", INHID.c_str());
    if (it == _set_inherited_interfaces.end()) {
      _set_inherited_interfaces.insert(INHID);
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    if(0)printf("_processNode inheritance SIF<%s>\n", INHID.c_str());
    if (it == _set_inherited_storage.end()) {
      ...
      OrkAssert(IFACE);
      _inherited_storage.push_back(IFACE);
      if (_onInheritStorageInterface)
        _onInheritStorageInterface(INHID, IFACE);
    } else {
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    OrkAssert(ast_uset);
    if(0)printf("_processNode inheritance SSET<%s>\n", INHID.c_str());
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    OrkAssert(ast_uset);
    if(0)printf("_processNode inheritance USET<%s>\n", INHID.c_str());
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    if(0)printf("_processNode inheritance UBLK<%s>\n", INHID.c_str());
...
void InheritanceTracker::fetchInheritances(astnode_ptr_t parent_node) {
  ...
  for (auto c : parent_node->_children) {
    ...
    //////////////////////////////////////////////////////////////////////
    else if (auto as_typ = std::dynamic_pointer_cast<SemaInheritTypeBlock>(c)) {
      auto INHID = as_typ->typedValueForKey<std::string>("inherit_id").value();
      auto TYP   = _translation_unit->find<TypeBlock>(INHID);
      OrkAssert(TYP);
      fetchInheritances(TYP);
      _processNode(as_typ);
    }
    //////////////////////////////////////////////////////////////////////
