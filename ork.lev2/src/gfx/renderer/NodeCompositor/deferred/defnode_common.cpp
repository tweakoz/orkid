...
void DeferredContext::gpuInit(Context* target) {
  ...
  if (nullptr == _rtgs_gbuffer) {
    _brdfIntegrationMap = PBRMaterial::brdfIntegrationMap(target,"GGX");
    //////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////
    _rtgs_gbuffer = std::make_shared<RtgSet>(target, MsaaSamples::MSAA_1X, "rtgs-gbuffer", "color"_crcu, true);
    _rtgs_gbuffer->addBuffer("DeferredGbuffer", EBufferFormat::RGBA32UI);
    _rtgs_gbuffer->_autoclear = false;
    //////////////////////////////////////////////////////////////
    _rtgs_laccum = std::make_shared<RtgSet>(target, MsaaSamples::MSAA_1X, "rtgs-laccum", "color"_crcu, true);
