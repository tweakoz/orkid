...
void BoundAndSplitModule::do_process(const ork::threadpool::sub_task* tsk, const ork::threadpool::thread_pool_worker* ptpw) {
  ...
  for (orkmap<const rend_shader*, TriangleMetaBucket*>::const_iterator itshader = metabucketmap.begin();
       itshader != metabucketmap.end();
       itshader++) {
    ...
    while (inumtri) {
      ...
      for (int it = 0; it < itx; it++) {
        ...
        ptribuffer[itribufferidx++] = v0.mObjSpaceNrm.x;
        ptribuffer[itribufferidx++] = v0.mObjSpaceNrm.y;
        ptribuffer[itribufferidx++] = v0.mObjSpaceNrm.z;
        ptribuffer[itribufferidx++] = v1.mObjSpaceNrm.x;
        ptribuffer[itribufferidx++] = v1.mObjSpaceNrm.y;
        ptribuffer[itribufferidx++] = v1.mObjSpaceNrm.z;
        ptribuffer[itribufferidx++] = v2.mObjSpaceNrm.x;
        ptribuffer[itribufferidx++] = v2.mObjSpaceNrm.y;
        ptribuffer[itribufferidx++] = v2.mObjSpaceNrm.z;

        ptribuffer[itribufferidx++] = v0.mWldSpaceNrm.x;
        ptribuffer[itribufferidx++] = v0.mWldSpaceNrm.y;
        ptribuffer[itribufferidx++] = v0.mWldSpaceNrm.z;
        ptribuffer[itribufferidx++] = v1.mWldSpaceNrm.x;
        ptribuffer[itribufferidx++] = v1.mWldSpaceNrm.y;
        ptribuffer[itribufferidx++] = v1.mWldSpaceNrm.z;
        ptribuffer[itribufferidx++] = v2.mWldSpaceNrm.x;
        ptribuffer[itribufferidx++] = v2.mWldSpaceNrm.y;
        ptribuffer[itribufferidx++] = v2.mWldSpaceNrm.z;

        ptribuffer[itribufferidx++] = v0.mWldSpacePos.x;
        ptribuffer[itribufferidx++] = v0.mWldSpacePos.y;
        ptribuffer[itribufferidx++] = v0.mWldSpacePos.z;
        ptribuffer[itribufferidx++] = v1.mWldSpacePos.x;
        ptribuffer[itribufferidx++] = v1.mWldSpacePos.y;
        ptribuffer[itribufferidx++] = v1.mWldSpacePos.z;
        ptribuffer[itribufferidx++] = v2.mWldSpacePos.x;
        ptribuffer[itribufferidx++] = v2.mWldSpacePos.y;
        ptribuffer[itribufferidx++] = v2.mWldSpacePos.z;

        ptribuffer[itribufferidx++] = v0.mObjSpacePos.x;
        ptribuffer[itribufferidx++] = v0.mObjSpacePos.y;
        ptribuffer[itribufferidx++] = v0.mObjSpacePos.z;
        ptribuffer[itribufferidx++] = v1.mObjSpacePos.x;
        ptribuffer[itribufferidx++] = v1.mObjSpacePos.y;
        ptribuffer[itribufferidx++] = v1.mObjSpacePos.z;
        ptribuffer[itribufferidx++] = v2.mObjSpacePos.x;
        ptribuffer[itribufferidx++] = v2.mObjSpacePos.y;
        ptribuffer[itribufferidx++] = v2.mObjSpacePos.z;
      }
      itribase += itx;
      inumtri -= itx;
      /////////////////////////////////////////////////////////
      ...
      while (i < knumfrag) {
        ...
        int icount     = (iremaining >= AABuffer::kfragallocsize) ? AABuffer::kfragallocsize : iremaining;
    ...
    for (int ix = 0; ix < itw; ix++) {
      ...
      for (int iaay = 0; iaay < imul; iaay++)
        for (int iaax = 0; iaax < imul; iaax++) {
          ...
          u32 upA = sorter.Composite(clear_color).RGBAU32();
          ////////////////////////////////////////////////////////////
          uA += ((upA)&0xff);
          uB += ((upA >> 8) & 0xff) >> 1;
          uG += ((upA >> 16) & 0xff) >> 1;
