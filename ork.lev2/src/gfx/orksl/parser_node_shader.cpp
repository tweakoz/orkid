...
///////////////////////////////////////////////////////////
void ShaderNode::parse(OrkSlParser* parser, const ScannerView& view) {
...
////////////////////////////////////////////////////
  ...
  bool is_vertex_shader   = pshader->_shadertype == EShaderType::Vertex;
  bool is_tessctrl_shader = pshader->_shadertype == EShaderType::TessCtrl;
  bool is_tesseval_shader = pshader->_shadertype == EShaderType::TessEval;
  bool is_geometry_shader = pshader->_shadertype == EShaderType::Geometry;
  bool is_fragment_shader = pshader->_shadertype == EShaderType::Fragment;
#if defined(ENABLE_NVMESH_SHADERS)
  bool is_nvtask_shader = pshader->_shadertype == EShaderType::NvTask;
  bool is_nvmesh_shader = pshader->_shadertype == EShaderType::NvMesh;
#endif
#if defined(ENABLE_COMPUTE_SHADERS)
  bool is_compute_shader = pshader->_shadertype == EShaderType::Compute;
#endif
