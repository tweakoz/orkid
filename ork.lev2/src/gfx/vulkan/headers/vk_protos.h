...
using vkfxshaderpass_ptr_t     = std::shared_ptr<VkFxShaderPass>;
using vkfxshaderpass_rawptr_t  = VkFxShaderPass*;
using vkfxshaderpassstate_rawptr_t = VkFxShaderPassState*;
