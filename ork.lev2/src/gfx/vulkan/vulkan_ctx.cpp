...
void VkContext::_doBeginPrimaryCommandBuffer() {
  ...
  printf( "BEGIN priCB<%p> impl<%p> vkhandle<%p> pending_cleanup=%zu\n",
...
void VkContext::_doEndFrame() {
  ...
  logchan_vkctx->log("CMDBUF: _doEndFrame: deallocating priCB<%p> impl<%p> vkhandle<%p>, pending_cleanup=%zu",
    (void*)_defaultCommandBuffer.get(),
