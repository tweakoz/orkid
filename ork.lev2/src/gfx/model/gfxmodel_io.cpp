...
static logchannel_ptr_t logchan_mioR = logger()->configureChannel("gfxmodelIOREAD", fvec3(0.8, 0.8, 0.4), false);
static logchannel_ptr_t logchan_mioW = logger()->configureChannel("gfxmodelIOWRITE", fvec3(0.8, 0.7, 0.4), false);
///////////////////////////////////////////////////////////////////////////////
...
bool XgmModel::_loaderSelect(XgmModel* mdl, datablock_ptr_t datablock) {
  ...
  if (check_magic.muVal32 == 0x736d656f) { // its encrypted
    ...
    printf("aaa: decrypted_datablock hash<%llx> length<%zu>\n", (ull)decrypted_datablock->hash(), decrypted_datablock->length());
