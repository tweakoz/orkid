...
float BiQuad::compute(float input) {
  ...
  float outputp = (_mfb0 * input) + (_mfb1 * _xm1) + (_mfb2 * _xm2);

  //- (_mfb0*_ym1)
  float outputn = -(_mfa1 * _ym1) - (_mfa2 * _ym2);
...
float BiQuad::compute2(float input) {
  ...
  float output = ((_mfb0 * input) + (_mfb1 * _xm1) + (_mfb2 * _xm2) - (_mfa1 * _ym1) - (_mfa2 * _ym2))
