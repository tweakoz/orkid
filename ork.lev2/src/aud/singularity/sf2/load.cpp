...
U32 SoundFont::GetSBFK(RIFFChunk* pROOT) {

  U32 rval         = 0;
  auto nchnk       = new RIFFChunk;
...
U32 SoundFont::GetINFOChunk(RIFFChunk* ParChunk, U32 offset) {
...
U32 SoundFont::GetINFOList(RIFFChunk* ParChunk, U32 offset) {
...
U32 SoundFont::GetSDTAChunk(RIFFChunk* ParChunk, U32 offset) {
  // printf( "get_chunk( 0x%x )\n", offset );
  U32 rval         = 0;
  U8* parchkdata   = ParChunk->GetChunkData();
  auto nchnk       = new RIFFChunk;
...
U32 SoundFont::GetSDTAList(RIFFChunk* ParChunk, U32 offset) {
...
U32 SoundFont::GetPDTAList(RIFFChunk* ParChunk, U32 offset) {
...
U32 SoundFont::GetPDTAChunk(RIFFChunk* ParChunk, U32 offset) {
  // printf( "get_chunk( 0x%x )\n", offset );
  U32 rval       = 0;
  U8* parchkdata = ParChunk->GetChunkData();
  ...
  // printf( "//////////////////////////\n" );
  if (nchnk->chunkID == RIFFChunk::ChunkName('p', 'h', 'd', 'r')) { // printf( "phdr chunk found!\n" );
  ...
  } else if (nchnk->chunkID == RIFFChunk::ChunkName('s', 'h', 'd', 'r')) { // printf( "//////////////////////////\n" );
  ...
  } else if (nchnk->chunkID == RIFFChunk::ChunkName('i', 'g', 'e', 'n')) { // printf( "//////////////////////////\n" );
  ...
  } else if (nchnk->chunkID == RIFFChunk::ChunkName('p', 'g', 'e', 'n')) { // printf( "//////////////////////////\n" );
  ...
  } else if (nchnk->chunkID == RIFFChunk::ChunkName('i', 'b', 'a', 'g')) { // printf( "//////////////////////////\n" );
  ...
  } else if (nchnk->chunkID == RIFFChunk::ChunkName('i', 'n', 's', 't')) { // printf( "//////////////////////////\n" );
  ...
  } else if (nchnk->chunkID == RIFFChunk::ChunkName('p', 'b', 'a', 'g')) { // printf( "//////////////////////////\n" );
  ...
  else { // printf( "UNKNOWN CHUNK at offset 0x%x!\n", offset );
    nchnk->DumpHeader();
  }
  // printf( "//////////////////////////\n" );
