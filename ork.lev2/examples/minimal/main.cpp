...
int main(int argc, char **argv) {
  ...
  //////////////////////////////////////////////////////////
  qtapp->setGpuInitCallback([&](Context *gfxctx) {
    deco::printf(fvec3::White(), "gpuINIT - context<%p>", gfxctx);
  });
  //////////////////////////////////////////////////////////
  qtapp->setDrawCallback([=](const ui::DrawEvent &drwev) {
  ...
  //////////////////////////////////////////////////////////
  qtapp->setResizeCallback(
      [=](int w, int h) { printf("GOTRESIZE<%d %d>\n", w, h); });
  //////////////////////////////////////////////////////////
  qtapp->setUiEventHandler([=](const ui::Event &ev) -> ui::HandlerResult {
