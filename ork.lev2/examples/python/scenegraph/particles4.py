...
def createParticleData( use_streaks = True ):
  ...
  class ImplObject(object):
    def __init__(self):
      ...
      self.emitter    = self.graphdata.create("EMITN",particles.LineEmitter)
      ...
      self.graphdata.connect( self.streaks.inputs.pool,    self.turbulence.outputs.pool )
...
class ParticlesApp(object):
  ...
  def onUpdate(self,updinfo):
    ...
    if hasattr(self.ptc_data,"emitter"):
      T = abstime
