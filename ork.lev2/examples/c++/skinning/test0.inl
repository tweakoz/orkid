...
skinning_test_ptr_t createTest0(GpuResources* gpurec) {
  ...
  test->_impl.makeShared<Test0IMPL>(gpurec);

  /////////////////////////////////////////////////////////////////////////////

  test->onActivate = [test]() {
    auto impl                  = test->_impl.getShared<Test0IMPL>();
