...
2. Mid level renderer building blocks
  ...
  * RenderQueues - state sorting drawbuffers.
  * Compositor - node based frame composition. 
  
3. Higher level renderers
  * Deferred Metallic-Roughness PBR renderer - implemented as a Node Compositor technique.
  ...
  * Picking renderer. Implemented as a Node Compositor technique. Pixel perfect picking support.
