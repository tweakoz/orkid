...
///////////////////////////////////////
template <typename T> Ref Module::signal(std::string key) {
...
template <typename T, typename... A> std::shared_ptr<T> Module::instance(std::string name, args_t conns, A&&... additional_args) {
