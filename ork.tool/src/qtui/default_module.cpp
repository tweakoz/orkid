...
void MainWinDefaultModule::Activate(QMenuBar* qmb) {
  ...
  AddAction("/Refresh/Models", QKeySequence(Qt::CTRL + Qt::Key_M));
  AddAction("/Refresh/Anims");
  AddAction("/Refresh/Textures", QKeySequence(Qt::CTRL + Qt::Key_T));
...
void MainWinDefaultModule::OnAction(const char* pact) {
  if (0 == strcmp("/Scene/NewScene", pact)) {
    mEditWin.NewScene();
  } else if (0 == strcmp("/Scene/OpenScene", pact)) {
    mEditWin.OpenSceneFile();
  } else if (0 == strcmp("/Scene/ExportArchetype", pact)) {
    mEditWin.SaveSelected();
  } else if (0 == strcmp("/Scene/ImportArchetype", pact)) {
    mEditWin.MergeFile();
  } else if (0 == strcmp("/Scene/Exit", pact)) {
    mEditWin.Exit();
  }
  ///////////////////////////////////////////////////////
  ...
  else if (0 == strcmp("/View/SaveLayout", pact)) {
    mEditWin.SaveLayout();
  } else if (0 == strcmp("/View/LoadLayout", pact)) {
    mEditWin.LoadLayout();
  } else if (0 == strcmp("/View/ToggleFullscreen", pact)) {
    mEditWin.ToggleFullscreen();
  }
  ///////////////////////////////////////////////////////
  else if (0 == strcmp("/Game/Local/Run", pact)) {
    mEditWin.RunLocal();
  } else if (0 == strcmp("/Game/Local/Stop", pact)) {
    mEditWin.StopLocal();
  }
  ///////////////////////////////////////////////////////
    ...
    mEditWin.NewEntities();
  } else if (0 == strcmp("/Entity/Group", pact)) {
    mEditWin.Group();
  }
  ///////////////////////////////////////////////////////
  else if (0 == strcmp("/&Archetype/E&xport", pact)) {
    mEditWin.ArchExport();
  } else if (0 == strcmp("/&Archetype/I&mport", pact)) {
    mEditWin.ArchImport();
  }
  ...
  ///////////////////////////////////////////////////////
  else if (0 == strcmp("/Refresh/Models", pact)) {
    mEditWin.RefreshModels();
  } else if (0 == strcmp("/Refresh/Anims", pact)) {
    mEditWin.RefreshAnims();
  } else if (0 == strcmp("/Refresh/Textures", pact)) {
    mEditWin.RefreshTextures();
  }
  ////////////////////////////////////////////////////////////////////////////////////////////////
