...
void LightMapperArchetype::Describe() {
  ...
  ork::reflect::annotatePropertyForEditor<LightMapperArchetype>(
      "FarmNodeGroups", "editor.factorylistbase", "EditorOnly/FarmNodeGroup");

  ork::reflect::RegisterProperty("ActiveBakeSettings", &LightMapperArchetype::mCurrentSetting);
  ork::reflect::annotatePropertyForEditor<LightMapperArchetype>(
      "ActiveBakeSettings", "ged.userchoice.delegate", "BakersChoiceDelegate");

  ork::reflect::RegisterProperty("ActiveRenderFarmGroup", &LightMapperArchetype::mCurrentNodeGroup);
  ork::reflect::annotatePropertyForEditor<LightMapperArchetype>(
      "ActiveRenderFarmGroup", "ged.userchoice.delegate", "FarmGroupChoiceDelegate");
}
...
void BakingGroup::Describe() {
  ...
  static const char* EdGrpStr = "sort://MatchItem MatchLights UseVertexColors "
...
void BakerSettings::Describe() {
  ...
  ork::reflect::annotateClassForEditor<LightMapperArchetype>(
      "editor.object.ops", ConstString("Atlas:AtlasMapperOps Bake:BakeOps "));
  ...
  static const char* EdGrpStr = "sort://DaeInput BakingGroups ActiveJobSet JobSets DebugPyg DebugPygEmbedGeom";
...
BakingGroupMatchItem BakerSettings::Match(const std::string& TestName) const {
  for (orklut<PoolString, BakingGroup*>::const_iterator it = mBakingGroupMap.begin(); it != mBakingGroupMap.end(); it++) {
