...
public:
  ...
  Outliner2Model(SceneEditorBase& ed, Outliner2Surface& v);
  ~Outliner2Model();
  ////////////////////////////////////////////////////////////////////
  void ToggleEnts();
  void ToggleArchs();
  ...
  void ToggleSystems();
  void ToggleGlobals();
  bool AreEntsEnabled() const {
    return mShowEnts;
  }
  bool AreArchsEnabled() const {
    return mShowArchs;
  }
  bool AreCompsEnabled() const {
    return mShowComps;
  }
  bool AreSystemsEnabled() const {
    return mShowSystems;
  }
  bool AreGlobalsEnabled() const {
    return mShowGlobals;
  }
  ////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////
  SceneEditorBase& Editor() const {
    return mEditor;
  }
  const std::vector<Outliner2Item>& Items() const {
    return mItems;
  }
...
///////////////////////////////////////////////////////////////////////////////
struct Outliner2Surface : public ui::Surface {
  Outliner2Surface(SceneEditorBase& ed);
