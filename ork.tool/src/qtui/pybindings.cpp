...
void orkpy_initork() {
  ...
  main_namespace["vec3"] = py::class_<fvec3>(mm, "vec3")
                               ...
                               .def("saturated", &fvec3::saturated)   // __add__
                               .def("clamped", &fvec3::clamped)       // __add__
  ...
  main_namespace["object"] = py::class_<ork::Object>(mm, "ork::Object").def("clazz", [](ork::Object* o) -> std::string {
