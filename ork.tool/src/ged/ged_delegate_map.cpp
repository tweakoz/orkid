...
///////////////////////////////////////////////////////////////////////////////
MapTraverseSerializer::MapTraverseSerializer(
    GedMapNode& mapnode,
...
bool MapTraverseSerializer::Serialize(const float& value) {
  ...
  if (iskey) {
    ...
    if (mLastHint == FindPooledString("fvec3")) {
      if (miFloatCounter == 2) {
        GedSimpleNode<GedMapIoDriver, fvec3>* simplenode =
            new GedSimpleNode<GedMapIoDriver, fvec3>(mModel, GetDecoKeyString().c_str(), mProp, mObject);
      ...
      //	);
      //
      GedFloatNode<GedMapIoDriver>* pfloatnode =
          new GedFloatNode<GedMapIoDriver>(mModel, GetDecoKeyString().c_str(), mProp, mObject);
...
bool MapTraverseSerializer::serializeObject(rtti::castable_rawconstptr_t value) {
  ...
  if (iskey) {
    ...
    if (anno.length()) {
      GedAssetNode<GedMapIoDriver>* itemnode = new GedAssetNode<GedMapIoDriver>(mModel, GetDecoKeyString().c_str(), mProp, mObject);
...
bool MapTraverseSerializer::Serialize(const PieceString& value) {
  ...
  if (iskey) {
    ...
    if (mMapValueTypeAnno.length()) {
      ...
      GedFileNode<GedMapIoDriver>* filenode = new GedFileNode<GedMapIoDriver>(mModel, GetDecoKeyString().c_str(), mProp, mObject);
      ...
      GedSimpleNode<GedMapIoDriver, PoolString>* simplenode =
          new GedSimpleNode<GedMapIoDriver, PoolString>(mModel, GetDecoKeyString().c_str(), mProp, mObject);
...
void MapItemWriteSerializer::Insert(const char* pchar) {
  ...
  bool bok =
      mMapProp->DeserializeElement(this, keyser, ork::reflect::IMap::kDeserializeInsertElement, mIoDriver.GetObject());
  OrkAssert(bok);
}
///////////////////////////////////////////////////////////////////////////////
...
void MapItemWriteSerializer::Remove(const KeyDecoName& kdeco) {
  ...
  bool bok = mMapProp->DeserializeElement(0, keyser, kdeco.miMultiIndex, mIoDriver.GetObject());
  OrkAssert(bok);
}
///////////////////////////////////////////////////////////////////////////////
void MapItemWriteSerializer::Move(const KeyDecoName& kdeco, const char* pname) {
  ...
  bok = mMapProp->DeserializeElement(0, keyser, kdeco.miMultiIndex, mIoDriver.GetObject());
...
void MapItemWriteSerializer::Import(const KeyDecoName& kdeco, const char* pname) {
  ...
  if (fname.length()) {
    ...
    lev2::GfxEnv::GetRef().GetGlobalLock().Lock();
    {
      ...
      bool bok = mMapProp->DeserializeElement(
...
void MapItemWriteSerializer::SetValue(rtti::ICastable* castable) {
  ...
  ork::PropSetContext pctx(ork::PropSetContext::EPROPEDITOR);
  MapKeyWriter keyser(mIoDriver);
  bool bok = mMapProp->DeserializeElement(this, keyser, mIoDriver.mDecoKey.miMultiIndex, mIoDriver.GetObject());
  OrkAssert(bok);
}
///////////////////////////////////////////////////////////////////////////////
