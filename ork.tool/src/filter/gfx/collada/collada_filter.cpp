...
template class ork::util::Context<ork::tool::meshutil::ColladaExportPolicy>;
...
public: //
  ...
  virtual bool ConvertAsset(const tokenlist& toklist) {
    return DAEToNAVCollision(toklist);
  }
};
...
public: //
  ...
  virtual bool ConvertAsset(const tokenlist& toklist) {
    return DAEToSECCollision(toklist);
  }
};
...
INSTANTIATE_TRANSPARENT_RTTI(ork::tool::meshutil::DAEXGMFilter, "DAEXGMFilter");
INSTANTIATE_TRANSPARENT_RTTI(ork::tool::meshutil::DAEXGAFilter, "DAEXGAFilter");
INSTANTIATE_TRANSPARENT_RTTI(ork::tool::meshutil::DAENAVFilter, "DAENAVFilter");
INSTANTIATE_TRANSPARENT_RTTI(ork::tool::meshutil::DAESECFilter, "DAESECFilter");
INSTANTIATE_TRANSPARENT_RTTI(ork::tool::meshutil::DAEDAEFilter, "DAEDAEFilter");
