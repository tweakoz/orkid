...
public:
	...
	void DrawAxis(GfxTarget* pTARG) const;
...
protected:
	...
	ork::CVector3 GetNormal() const final { return ork::CVector3::UnitX(); };
};
...
protected:
	...
	ork::CVector3 GetNormal() const final { return ork::CVector3::UnitY(); };
};
...
protected:
	...
	ork::CVector3 GetNormal() const final { return ork::CVector3::UnitZ(); };
};
