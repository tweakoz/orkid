...
{
	DirectObjectPropertyType<MemberType> *prop = 
		new DirectObjectPropertyType<MemberType>(
			static_cast<MemberType Object::*>(member));
...
static inline AccessorObjectPropertyType<MemberType> &RegisterProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
	AccessorObjectPropertyType<MemberType> *prop = 
		new AccessorObjectPropertyType<MemberType>(
			static_cast<void (Object::*)(MemberType &) const>(getter),
...
static inline AccessorObjectPropertyObject &RegisterProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
	AccessorObjectPropertyObject *prop = 
		new AccessorObjectPropertyObject(
			static_cast<Object *(Object::*)()>(accessor));
...
static inline AccessorObjectPropertyVariant &RegisterProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
	AccessorObjectPropertyVariant *prop = 
		new AccessorObjectPropertyVariant(
			static_cast<bool (Object::*)(ISerializer &) const>(serialize),
...
static DirectObjectArrayPropertyType<MemberType> &RegisterArrayProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
    DirectObjectArrayPropertyType<MemberType> *prop = 
		new DirectObjectArrayPropertyType<MemberType>(
			// reinterpret_cast is necessary here, the static_cast goes as far as possible,
			// the reinterpret_cast just removes the size info from the array
			reinterpret_cast<MemberType (Object::*)[]>(
                 static_cast<MemberType (Object::*)[size]>(pmember)), size);
...
static DirectObjectVectorPropertyType<MemberType> &RegisterArrayProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
    DirectObjectVectorPropertyType<MemberType> *prop = 
		new DirectObjectVectorPropertyType<MemberType>(
           static_cast<MemberType Object::*>(pmember));
...
static inline AccessorObjectArrayPropertyType<MemberType> &RegisterArrayProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
	AccessorObjectArrayPropertyType<MemberType> *prop = 
		new AccessorObjectArrayPropertyType<MemberType>(
...
static inline AccessorObjectArrayPropertyObject &RegisterArrayProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
	AccessorObjectArrayPropertyObject *prop = 
		new AccessorObjectArrayPropertyObject(
...
static inline AccessorObjectArrayPropertyVariant &RegisterArrayProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
	AccessorObjectArrayPropertyVariant *prop = 
		new AccessorObjectArrayPropertyVariant(
...
static inline DirectObjectMapPropertyType<MapType> &RegisterMapProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
	DirectObjectMapPropertyType<MapType> *prop =
		new DirectObjectMapPropertyType<MapType>(static_cast<MapType Object::*>(member));
...
static inline AccessorObjectMapPropertyType<KeyType, ValueType> &RegisterMapProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
	AccessorObjectMapPropertyType<KeyType, ValueType> *prop = 
		new AccessorObjectMapPropertyType<KeyType, ValueType>(
		static_cast<bool (Object::*)(const KeyType &, int, ValueType &) const>(getter),
		static_cast<void (Object::*)(const KeyType &, int, const ValueType &)>(setter),
...
static inline AccessorObjectMapPropertyObject<KeyType> &RegisterMapProperty(
	...
	Description &description = ClassType::GetClassStatic()->Description())
{
	AccessorObjectMapPropertyObject<KeyType> *prop = 
		new AccessorObjectMapPropertyObject<KeyType>(
...
static inline void RegisterFunctor(
	const char *name, 
...
static void RegisterSignal(
	const char *name,
	object::Signal ClassType::*pmember )
{
	Description &description = ClassType::GetClassStatic()->Description();
	description.AddSignal(name, 
		static_cast<object::Signal Object::*>(pmember));
}

template<typename ClassType,typename FunctionType>
static void RegisterSlot(
	const char *name,
	object::AutoSlot ClassType::*pmember,
	FunctionType function )
{
	Description &description = ClassType::GetClassStatic()->Description();
	RegisterFunctor( name, function );
	description.AddAutoSlot(name, 
		static_cast<object::AutoSlot Object::*>(pmember));
}
...
template <typename ClassType>
inline void AnnotateProperty( const char* PropName, const char* Key, const char* Val )
{
	Description &description = ClassType::GetClassStatic()->Description();
	description.AnnotateProperty( PropName, Key, Val );
}
template <typename ClassType>
inline void AnnotatePropertyForEditor( const char* PropName, const char* Key, const char* Val )
{
...
template <typename ClassType>
inline void AnnotateClassForEditor( const char* Key, const any16& Val )
{
#if defined( ORK_CONFIG_EDITORBUILD )
	Description &description = ClassType::GetClassStatic()->Description();
...
template <typename T>
void RegisterFloatMinMaxProp( float T::* member, const char* prop_name, const char* fmin, const char* fmax )
{
...
template <typename T>
void RegisterIntMinMaxProp( int T::* member, const char* prop_name, const char* imin, const char* imax )
{
	RegisterProperty(prop_name, member);
