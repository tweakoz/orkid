...
# define TIXML_FILE_PRINTF	fprintf
#endif
	...
	#endif
#else
	#include <ork/file/tinyxml/tinystr.h>
...
public:
	...
	*/
	virtual void Print( TIXML_FILE* file, int depth ) const = 0;
#endif
...
public:
	...
	*/
	...
	virtual void Print( TIXML_FILE* file, int depth ) const;
...
public:
	...
	*/
	void SetProperty( const char* name, const char * _value );
	...
	/// STL std::string form.
	void SetProperty( const std::string& name, const std::string& _value );
	///< STL std::string form.
	void SetProperty( const std::string& name, int _value );
	#endif
...
public:
	...
	*/
	bool LoadFileFromBuffer( char* buf, int length, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	bool LoadFileFromBufferEx( char* buf, int length, bool auto_deallocbuf = false, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	...
	*/
	...
	#ifdef TIXML_WRITE
		// TODO: make a stdout Print that works with Orkid File IO
	# ifndef TIXML_ORKID_FILEIO
	...
	virtual void Print( TIXML_FILE* file, int depth = 0 ) const;
#endif
...
/**
	...
	Assuming you want the value of "PropertyB" in the 2nd "Child" element, it's very 
