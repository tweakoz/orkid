...
template <typename T> T det3x3(T a1, T a2, T a3, T b1, T b2, T b3, T c1, T c2, T c3) {
  T ans = a1 * det2x2(b2, b3, c2, c3) - b1 * det2x2(a2, a3, c2, c3) + c1 * det2x2(a2, a3, b2, b3);
...
template <typename T> T det4x4(const Matrix44<T>& m) {
  ...
  T ans = a1 * det3x3(b2, b3, b4, c2, c3, c4, d2, d3, d4) - b1 * det3x3(a2, a3, a4, c2, c3, c4, d2, d3, d4) +
...
template <typename T>
void GEMSadjoint(const Matrix44<T>& in, Matrix44<T>& out) // Matrix4 *in; Matrix4 *out;
{
