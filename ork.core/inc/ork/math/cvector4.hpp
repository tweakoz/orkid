...
template <typename T> TVector4<T>::TVector4() : x(T(0.0f)), y(T(0.0f)), z(T(0.0f)), w(T(1.0f)) {}

///////////////////////////////////////////////////////////////////////////////

template <typename T> TVector4<T>::TVector4(T _x, T _y, T _z, T _w) : x(_x), y(_y), z(_z), w(_w) {}

///////////////////////////////////////////////////////////////////////////////

template <typename T> TVector4<T>::TVector4(const TVector3<T>& in, T w) : x(in.x), y(in.y), z(in.z), w(w) {}

////////////////////////////////////////////////////////////////////////////////

template <typename T> uint64_t TVector4<T>::GetRGBAU64(void) const {
...
template <typename T> void TVector4<T>::SetRGBAU64(uint64_t inp) {
...
template <typename T> T TVector4<T>::Dot(const TVector4<T>& vec) const { return ((x * vec.x) + (y * vec.y) + (z * vec.z)); }

////////////////////////////////////////////////////////////////////////////////

template <typename T>
TVector4<T> TVector4<T>::Cross(const TVector4<T>& vec) const // c = this X vec
{
...
template <typename T> T TVector4<T>::Mag(void) const { return Sqrt(x * x + y * y + z * z); }
...
template <typename T>
void TVector4<T>::Serp(const TVector4<T>& PA, const TVector4<T>& PB, const TVector4<T>& PC, const TVector4<T>& PD, T Par) {
  TVector4<T> PAB, PCD;
  PAB.Lerp(PA, PB, Par);
  PCD.Lerp(PC, PD, Par);
  Lerp(PAB, PCD, Par);
...
template <typename T>
T TVector4<T>::CalcTriArea(const TVector4<T>& V0, const TVector4<T>& V1, const TVector4<T>& V2, const TVector4<T>& N) {
