...
// DEBUG define changed to _DEBUG cause that is what we're using in our preprocessor
// and plain ol' DEBUG stomps over FCollada. =oz
    ...
    *text = "";
		 ...
		 || !condenseWhiteSpace )	// if true, whitespace is always kept
	{
			  ...
			  )
		{
			...
			text->append( cArr, (unsigned int)len );
		}
	}
	else
	{
