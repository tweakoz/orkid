...
INSTANTIATE_TRANSPARENT_RTTI(ork::dataflow::floatxfitembase,
                             "dflow/floatxfitembase");
INSTANTIATE_TRANSPARENT_RTTI(ork::dataflow::floatxfmsbcurve,
                             "dflow/floatxfmsbcurve");
INSTANTIATE_TRANSPARENT_RTTI(ork::dataflow::floatxfmodstep,
                             "dflow/floatxfmodstep");
...
INSTANTIATE_TRANSPARENT_TEMPLATE_RTTI(OrkDataflowOutPlugFloat,
                                      "dflow/outplug<float>");
INSTANTIATE_TRANSPARENT_TEMPLATE_RTTI(OrkDataflowInpPlugFloat,
                                      "dflow/inplug<float>");
INSTANTIATE_TRANSPARENT_TEMPLATE_RTTI(OrkDataflowOutPlugFloat3,
                                      "dflow/outplug<vect3>");
INSTANTIATE_TRANSPARENT_TEMPLATE_RTTI(OrkDataflowInpPlugFloat3,
                                      "dflow/inplug<vect3>");
INSTANTIATE_TRANSPARENT_TEMPLATE_RTTI(OrkDataflowFloatInpPlugXf,
                                      "dflow/inplugxf<float,floatxf>");
INSTANTIATE_TRANSPARENT_TEMPLATE_RTTI(OrkDataflowFloat3InpPlugXf,
                                      "dflow/inplugxf<vect3,vect3xf>");
...
void floatxfmsbcurve::Describe() {
  ...
  ork::reflect::RegisterProperty("ModScaleBias",
                                 &floatxfmsbcurve::ModScaleBiasAccessor);

  ork::reflect::RegisterProperty("domodscabia",
                                 &floatxfmsbcurve::mbDoModScaBia);
...
plugroot::plugroot(module *pmod, EPlugDir edir, EPlugRate epr,
                   const std::type_info &tid, const char *pname)
    : mePlugDir(edir), mModule(pmod), mTypeId(tid), mePlugRate(epr),
      mPlugName(pname ? ork::AddPooledLiteral(pname)
                      : ork::AddPooledLiteral("noname")) {
...
///////////////////////////////////////////////////////////////////////////////
inplugbase::inplugbase(module *pmod, EPlugRate epr, const std::type_info &tid,
                       const char *pname)
    : plugroot(pmod, EPD_INPUT, epr, tid, pname), mExternalOutput(0),
      mpMorphable(0) {
  if (GetModule())
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
outplugbase::outplugbase(module *pmod, EPlugRate epr, const std::type_info &tid,
                         const char *pname)
    : plugroot(pmod, EPD_OUTPUT, epr, tid, pname), mpRegister(0) {
  if (GetModule())
...
outplugbase::~outplugbase() {
  ...
  while (GetNumExternalOutputConnections()) {
    inplugbase *pcon =
        GetExternalOutputConnection(GetNumExternalOutputConnections() - 1);
    pcon->Disconnect();
  }
}
///////////////////////////////////////////////////////////////////////////////
...
void outplugbase::Disconnect(inplugbase *pinplug) {
  auto it = std::find(mExternalInputConnections.begin(),
                      mExternalInputConnections.end(), pinplug);
...
module::module()
    : mpMorphable(nullptr), mNumStaticInputs(0), mNumStaticOutputs(0) {}
module::~module() {}

///////////////////////////////////////////////////////////////////////////////
void module::SetInputDirty(inplugbase *plg) { DoSetInputDirty(plg); }
///////////////////////////////////////////////////////////////////////////////
void module::SetOutputDirty(outplugbase *plg) { DoSetOutputDirty(plg); }
///////////////////////////////////////////////////////////////////////////////
...
inplugbase *GetInput(int idx) { return 0; }
outplugbase *GetOutput(int idx) { return 0; }
///////////////////////////////////////////////////////////////////////////////
