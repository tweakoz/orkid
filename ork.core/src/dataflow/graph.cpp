...
///////////////////////////////////////////////////////////////////////////////
ImplementReflectionX(ork::dataflow::graph_data, "dflow/graphdata");
ImplementReflectionX(ork::dataflow::graph_inst, "dflow/graph");
...
void graph_data::describeX(object::ObjectClass* clazz) {
  ...
  clazz
      ->accessorVariant(
          "zzz_connections", //
          &graph_inst::SerializeConnections,
          &graph_inst::DeserializeConnections)
      ->annotate<bool>(
          "editor.visible", //
          false);
