...
//////////////////////////////////////////////////////////////////////////////
/*
bool ObjectModel::IsNodeVisible(const reflect::IObjectProperty* prop) {
...
GedItemNode* ObjectModel::CreateNode(
  ...
  /////////////////////////////////////////////////////////////////////////
  else if (const reflect::DirectPropertyType<ork::object_ptr_t>* dobjprop = rtti::autocast(prop)) {
