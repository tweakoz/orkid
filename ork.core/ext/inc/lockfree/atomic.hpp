...
#include <lockfree/memory_order.hpp>
#include <lockfree/atomic/platform.hpp>
#include <lockfree/atomic/detail/base.hpp>
#include <lockfree/atomic/detail/integral-casts.hpp>
