...
#include <boost/config.hpp>
	...
	#include <lockfree/atomic/detail/gcc-x86.hpp>

#elif defined(__GNUC__) && defined(__alpha__)

	#include <lockfree/atomic/detail/gcc-alpha.hpp>

#elif defined(__GNUC__) && (defined(__POWERPC__) || defined(__PPC__))

	#include <lockfree/atomic/detail/gcc-ppc.hpp>
...
// I don't know how complete it is.
	...
	#include <lockfree/atomic/detail/gcc-armv6+.hpp>

#elif defined(__linux__) && defined(__arm__)

	#include <lockfree/atomic/detail/linux-arm.hpp>
	...
	#include <lockfree/atomic/detail/interlocked.hpp>

#else

	#warning "Using slow fallback atomic implementation"
	#include <lockfree/atomic/detail/generic-cas.hpp>
