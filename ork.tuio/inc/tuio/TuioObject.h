...
namespace TUIO {
	...
	public:
		 ...
		 */
		void _update (TuioTime ttime, float xp, float yp, float a, float xs, float ys, float rs, float ma, float ra) {
		 ...
		 * @param	ra	the rotation acceleration to assign
		 */
		void _update (float xp, float yp, float a, float xs, float ys, float rs, float ma, float ra) {
		 ...
		 * @param	a	the angle coordinate to assign
		 */
		void _update (TuioTime ttime, float xp, float yp, float a) {
