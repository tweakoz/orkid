      ...
      if (strcmp(cmd, "set") == 0) {
        ...
        if (tobj == objectList.end()) {
          ...
          frameObjects.push_back(addObject);
            ...
            ((*tobj)->getX() != xpos) || ((*tobj)->getY() != ypos) || ((*tobj)->getAngle() != angle) ||
            ((*tobj)->getXSpeed() != xspeed) || ((*tobj)->getYSpeed() != yspeed) || ((*tobj)->getRotationSpeed() != rspeed) ||
          ...
          for (std::list<TuioObject*>::iterator iter = frameObjects.begin(); iter != frameObjects.end(); iter++) {
            ...
            switch (tobj->getTuioState()) {
              ...
              case TUIO_ADDED:
                ...
                lockObjectList();
                frameObject = new TuioObject(
                    currentTime, tobj->getSessionID(), tobj->getSymbolID(), tobj->getX(), tobj->getY(), tobj->getAngle());
      ...
      if (strcmp(cmd, "set") == 0) {
        ...
        if (tcur == cursorList.end()) {
          ...
          frameCursors.push_back(addCursor);
            ...
            ((*tcur)->getX() != xpos) || ((*tcur)->getY() != ypos) || ((*tcur)->getXSpeed() != xspeed) ||
            ((*tcur)->getYSpeed() != yspeed) || ((*tcur)->getMotionAccel() != maccel)) {
            ...
            switch (tcur->getTuioState()) {
              ...
              default:
                ...
                if ((tcur->getX() != frameCursor->getX() && tcur->getXSpeed() == 0) ||
                  ...
                  frameCursor->update(
                      currentTime, tcur->getX(), tcur->getY(), tcur->getXSpeed(), tcur->getYSpeed(), tcur->getMotionAccel());
