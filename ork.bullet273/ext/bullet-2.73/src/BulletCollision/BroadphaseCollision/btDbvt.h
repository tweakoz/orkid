...
#if defined(_XBOX)
#define DBVT_IMPL_GENERIC		1	// Generic implementation	
#define DBVT_IMPL_SSE			0	// SSE
#else
...
#ifdef WII //e Wii does not have memmove functions
...
#elif (defined (WIN32) && (_MSC_VER) && _MSC_VER >= 1400) && (!defined (BT_USE_DOUBLE_PRECISION))
