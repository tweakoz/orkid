...
void btOptimizedBvh::build(btStridingMeshInterface* triangles, bool useQuantizedAabbCompression, const btVector3& bvhAabbMin, const btVector3& bvhAabbMax)
{
	...
	struct	QuantizedNodeTriangleCallback : public btInternalTriangleIndexCallback
	{
		...
		QuantizedNodeTriangleCallback(QuantizedNodeArray&	triangleNodes,const btQuantizedBvh* tree, int ireserve )
			:m_triangleNodes(triangleNodes),m_optimizedTree(tree)
		{
			m_triangleNodes.resize( ireserve );
		}
	...
	if (m_useQuantization)
	{
		...
		void* pcheck = new char[8];

		QuantizedNodeTriangleCallback	callback(m_quantizedLeafNodes,this,ires);
