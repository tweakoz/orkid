...
public:
  ...
  SimulationEvent(Simulation* psi, ESIEvent ev)
      : mpSimulation(psi)
      , mEvent(ev) {
  }
  ...
  ESIEvent GetEvent() const {
    return mEvent;
  }
  void SetUserData(const anyp& ud) {
    mUserData = ud;
  }
  const anyp& GetUserData() const {
    return mUserData;
  }
...
public:
  ...
  void SetSimulationMode(ESimulationMode emode) {
    OnSimulationMode(emode);
  }
  ESimulationMode GetSimulationMode() const {
    return meSimulationMode;
  }
  ...
  const EntitySet& GetActiveEntities() const {
    return mActiveEntities;
  }
  EntitySet& GetActiveEntities() {
    return mActiveEntities;
  }
  ...
  float GetUpDeltaTime() const {
    return mUpDeltaTime;
  }

  void SetDeltaTime(float speeduptime) {
    mDeltaTime = speeduptime;
  }
  ...
  const ActiveComponentType& GetActiveEntityComponents() const {
    return mActiveEntityComponents;
  }
  ActiveComponentType& GetActiveEntityComponents() {
    return mActiveEntityComponents;
  }
