...
private:
	...
	virtual ComponentInst *DoCreateComponent(Entity *pent) const final;

	const char* GetShortSelector() const  final { return "dfr"; } // virtual
...
private:
	...
	bool DoNotify(const event::Event *event) final; // virtual
