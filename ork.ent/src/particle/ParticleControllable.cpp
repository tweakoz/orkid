...
ParticleControllableInst::ParticleControllableInst(const ParticleControllableData& data, ork::ent::Entity* pent)
  ...
  const ork::ent::DataflowRecieverComponentData* dflowreciever =
      pent->data()->GetTypedComponent<ork::ent::DataflowRecieverComponentData>();
  if (dflowreciever) {
...
template const ork::psys::ParticleControllableData*
ork::ent::EntData::GetTypedComponent<ork::psys::ParticleControllableData>() const;
