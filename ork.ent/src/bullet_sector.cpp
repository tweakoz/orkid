...
ork::ent::ComponentInst *TrackData::DoCreateComponent(ork::ent::Entity *pent) const
{
...
ork::ent::ComponentInst *SectorTrackerData::DoCreateComponent(ork::ent::Entity *pent) const
{
