...
void AudioEffectPlayDataBase::Describe() {
  ...
  ork::reflect::annotatePropertyForEditor<AudioEffectPlayDataBase>(
      "MutexGroup", "ged.userchoice.delegate", "AudioMutexGroupChoiceDelegate");
  ork::reflect::annotatePropertyForEditor<AudioEffectPlayDataBase>(
      "SubMixGroup", "ged.userchoice.delegate", "AudioSubMixChoiceDelegate");
...
void AudioMultiEffectPlayData::Describe() {
  ...
  ork::reflect::annotatePropertyForEditor<AudioMultiEffectPlayData>(
      "SubSounds", "editor.factorylistbase", "AudioMultiEffectPlayDataItemBase");
...
AudioMultiEffectPlayData::~AudioMultiEffectPlayData() {
  for (ork::orklut<ork::PoolString, AudioMultiEffectPlayDataItemBase*>::const_iterator it = GetSubSoundMap().begin();
       it != GetSubSoundMap().end();
       it++) {
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
ork::lev2::AudioInstrumentPlayback*
AudioMultiEffectPlayInst::Play(AudioEffectComponentInst* aeci, int inote, int ivel, const ork::TransformNode* pnode) {
...
AudioMultiEffectPlayInst::AudioMultiEffectPlayInst(const AudioEffectComponentInst& aeci, const AudioMultiEffectPlayData& pdata)
  ...
  int inumv = 0;
  for (ork::orklut<ork::PoolString, AudioMultiEffectPlayDataItemBase*>::const_iterator it = sndmap.begin(); it != sndmap.end();
       it++) {
    const ork::PoolString& subname         = it->first;
...
AudioMultiEffectPlayInst::~AudioMultiEffectPlayInst() {
  for (ork::orklut<ork::PoolString, AudioMultiEffectPlayInstItemBase*>::const_iterator it = GetSubSoundMap().begin();
       it != GetSubSoundMap().end();
       it++) {
    const ork::PoolString& subname         = it->first;
...
///////////////////////////////////////////////////////////////////////////////
ork::lev2::AudioInstrumentPlayback*
AudioMultiEffectPlayInst::DoPlay(AudioEffectComponentInst* aeci, ork::lev2::AudioIntrumentPlayParam& param) {
    ...
    if (pbank) {
      ...
      if (Program) {
        if (CheckPlayTracker(Program)) {
          ...
          if (sound_playback)
            sound_playback->SetUserData0(anyp(pitem));
          return sound_playback;
        }
      }
    }
...
void AudioMultiEffectPlayDataItemBase::Describe() {
  ...
  ork::reflect::annotatePropertyForEditor<AudioMultiEffectPlayDataItemBase>(
      "Note", "ged.userchoice.delegate", "AudioNoteChoiceDelegate");
  ork::reflect::annotatePropertyForEditor<AudioMultiEffectPlayDataItemBase>(
      "BankName", "ged.userchoice.delegate", "AudioBankChoiceDelegate");
  ork::reflect::annotatePropertyForEditor<AudioMultiEffectPlayDataItemBase>(
      "ProgramName", "ged.userchoice.delegate", "AudioProgramChoiceDelegate");
}
...
ork::lev2::AudioInstrumentPlayback*
AudioMultiEffectPlayInstItemBase::Play(AudioEffectComponentInst* aeci, ork::lev2::AudioIntrumentPlayParam& param) {
...
ork::lev2::AudioInstrumentPlayback*
AudioMultiEffectPlayInstItemFixed::DoPlay(AudioEffectComponentInst* aeci, ork::lev2::AudioIntrumentPlayParam& param) {
  ork::lev2::AudioInstrumentPlayback* sound_playback = ork::lev2::AudioDevice::GetDevice()->PlaySound(param.mProgram, param);
  return sound_playback;
}
...
AudioMultiEffectPlayInstItemSingularity::AudioMultiEffectPlayInstItemSingularity(
    const AudioMultiEffectPlayDataItemSingularity& itemdata)
    : AudioMultiEffectPlayInstItemBase(itemdata)
    , mItemData(itemdata) {
}
...
ork::lev2::AudioInstrumentPlayback*
AudioMultiEffectPlayInstItemSingularity::DoPlay(AudioEffectComponentInst* aeci, ork::lev2::AudioIntrumentPlayParam& param) {
  return nullptr;
}
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
...
ork::lev2::AudioInstrumentPlayback*
AudioMultiEffectPlayInstItemModular::DoPlay(AudioEffectComponentInst* aeci, ork::lev2::AudioIntrumentPlayParam& param) {
  ork::lev2::AudioGraph* graph = gbusetemplate ? (ork::lev2::AudioGraph*)&mItemData.GetTemplate() : mGraphPool.Allocate();
...
public:
  SoundMapPropertyType(MapType ork::Object::*obj)
      : SuperType(obj) {
  }
...
void AudioEffectComponentData::Describe() {
  ...
  ork::reflect::annotatePropertyForEditor<AudioEffectComponentData>(
      "SoundMap", "editor.factorylistbase", "AudioEffectPlayDataBase");
}
...
AudioEffectComponentData::~AudioEffectComponentData() {
  for (ork::orklut<ork::PoolString, AudioEffectPlayDataBase*>::const_iterator it = mSoundMap.begin(); it != mSoundMap.end(); it++) {
    delete it->second;
  }
}
///////////////////////////////////////////////////////////////////////////////
...
AudioEffectComponentInst::~AudioEffectComponentInst() {
  StopAllSounds();
  for (ork::orklut<ork::PoolString, AudioMultiEffectPlayInst*>::const_iterator it = mSoundMap.begin(); it != mSoundMap.end();
       it++) {
...
void AudioEffectComponentInst::DoUpdate(ork::ent::Simulation* inst) {
  if (mPlaybacks.size()) {
    ...
    for (orkvector<ork::lev2::AudioInstrumentPlayback*>::const_iterator it = mPlaybacks.begin(); it != mPlaybacks.end(); it++) {
  ...
  for (int ie = 0; ie < inumemitters; ie++) {
    ...
    if (emitterctx.mbEmitterToggle) {
      if (emitterctx.mEmitterPB) {
        if (emitterctx.mEmitterPB->GetSerialNumber() != emitterctx.miEmitterSN) { // voices were cutoff, restart
...
///////////////////////////////////////////////////////////////////////////////
ork::lev2::AudioInstrumentPlayback*
AudioEffectComponentInst::PlaySoundEx(ork::PoolString soundname, int inote, int ivel, const ork::TransformNode* pnode) {
...
///////////////////////////////////////////////////////////////////////////////
ork::lev2::AudioInstrumentPlayback*
AudioEffectComponentInst::PlaySound(ork::PoolString soundname, const ork::TransformNode* pnode) {
...
bool AudioEffectComponentInst::DoNotify(const ork::event::Event* pev) {
  ...
  if (auto stopevent = dynamic_cast<const event::StopSoundEvent*>(pev)) {
    const ork::PoolString& sound_name = stopevent->GetSoundName();
