...
public:
	...
	ModItemBufferData() 
		...
		, mpDrawable(0)
		, mpMIRD(0)
		, mDB( ork::ent::DrawableBuffer::kmaxbuffers+1 )
	{
	}
	~ModItemBufferData()
	{
	...
	ork::ent::CallbackDrawable*	mpDrawable;
...
NovaParticleSystem* ModParticleItem::CreateSystem( ork::ent::Entity* pent ) const
{	//////////////////////////////////////////////////////////////////////////////
...
bool ModularSystem::DoNotify(const event::Event *event)
{
	if( const ork::ent::PerfSnapShotEvent* psse = rtti::autocast(event) )
	{
		...
		for( orklut<ork::PoolString,ork::Object*>::const_iterator itm=template_modules.begin(); itm!=template_modules.end(); itm++ )
		{
...
void ModularSystem::DoLinkSystem( ork::ent::SceneInst* psi, ork::ent::Entity* pent )
{
	...
	if( mGraphInstance )
	{
		...
		{	RendererModule* renderer = GetRenderer(ir);
			...
			////////////////////////////////////////////////////////
			class Destroyer : public ork::ent::ICallbackDrawableDataDestroyer
			{
				ModItemRenderData*	mpMIRD;
			...
			public:
				Destroyer(ModItemRenderData*pird) : mpMIRD(pird) {}
			};
			////////////////////////////////////////////////////////
			////////////////////////////////////////////////////////
