...
BulletObjectForceControllerInst*
TestForceControllerData::CreateForceControllerInst(const BulletObjectControllerData& data, ork::ent::Entity* pent) const {
...
void TestForceControllerInst::UpdateForces(ork::ent::Simulation* inst, BulletObjectControllerInst* boci) {
  ...
  // torque to for ROLL
  {
    ...
    float kfmaxT = std::clamp(mTestData.mTorque * 0.1f, -kfmaxT, +kfmaxT);
...
BulletObjectForceControllerInst*
DirectionalForceData::CreateForceControllerInst(const BulletObjectControllerData& data, ork::ent::Entity* pent) const {
