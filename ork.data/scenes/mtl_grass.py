###############################################################################
# mtl_grass.py — procedural volumetric Grass on a sphere (GEOV2 ptex3d).
#
...
#
#   ork.scene.viewer.py mtl_grass
###############################################################################

from orkengine.core import lev2_pyexdir, vec3
from ork.hypergraph.ecs.scene import Scene
from ork.hypergraph.assets.materials import Grass
...
class GrassScene(Scene):
  ...
  def __init__(self):
    ...
    mat = A.Ptex3d("grass_mtl",
                   dsl_class=Grass)
    drw = A.IcoSphere("grass_sphere",
                      radius=2.5,
                      subdivisions=6,
                      material=mat)
