###############################################################################
# mtl_cheetah.py — procedural volumetric Cheetah skin on a sphere (GEOV2 ptex3d).
#
...
#
#   ork.scene.viewer.py mtl_cheetah
###############################################################################

from orkengine.core import lev2_pyexdir, vec3
from ork.hypergraph.ecs.scene import Scene
from ork.hypergraph.assets.materials import Cheetah

lev2_pyexdir.addToSysPath()


class CheetahScene(Scene):

  def __init__(self):
    super().__init__()                       # self.SG = default ForwardPBR scenegraph
    A = self.asset

    mat = A.Ptex3d("cheetah_mtl",
                   dsl_class=Cheetah)
    drw = A.IcoSphere("cheetah_sphere",
                      radius=2.5,
                      subdivisions=6,
                      material=mat)
