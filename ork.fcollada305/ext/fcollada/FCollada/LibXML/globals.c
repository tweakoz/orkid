...
#if defined(_WIN32)
void* __cdecl myalloc( unsigned int isize );
void* __cdecl myrealloc( void *ptr, unsigned int size );
void __cdecl myfree( void* pwhere );
#else
void* myalloc( unsigned int isize );
void* myrealloc( void *ptr, unsigned int size );
void  myfree( void* pwhere );
#endif
 ...
 */
xmlFreeFunc xmlFree = (xmlFreeFunc) myfree;
/**
 * xmlMalloc:
 ...
 */
xmlMallocFunc xmlMalloc = (xmlMallocFunc) myalloc;
/**
 * xmlMallocAtomic:
 * @size:  the size requested in bytes
 *
 ...
 * Returns a pointer to the newly allocated block or NULL in case of error
 */
xmlMallocFunc xmlMallocAtomic = (xmlMallocFunc) myalloc;
/**
 * xmlRealloc:
 * @mem: an already allocated block of memory
 ...
 */
xmlReallocFunc xmlRealloc = (xmlReallocFunc) myrealloc;
/**
 * xmlMemStrdup:
