...
private:
	...
	DeclareParameterAnimatable(FMMatrix44, FUParameterQualifiers::VECTOR, ViewMtx, FC("ViewMatrix"));
	DeclareParameterAnimatable(FMMatrix44, FUParameterQualifiers::VECTOR, ProjMtx, FC("ProjMatrix"));
...
public:
	...
	inline FCDParameterAnimatableMatrix44& GetViewMtx() { return ViewMtx; }
	inline FCDParameterAnimatableMatrix44& GetProjMtx() { return ProjMtx; }
