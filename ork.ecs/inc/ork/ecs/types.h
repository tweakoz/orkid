...
struct BoidsComponentData;
struct BoidsSystemData;
...
using boidscompdata_ptr_t = std::shared_ptr<BoidsComponentData>;
using boidssysdata_ptr_t = std::shared_ptr<BoidsSystemData>;
