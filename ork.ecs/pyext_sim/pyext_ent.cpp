...
/////////////////////////////////////////////////////////////////////////////////
  auto eref_t = clazz<nanobindadapter,EntityRef>(module, "EntityRef")
  .prop_ro("id",[](EntityRef eref) -> uint64_t {
    return eref._entID;
  });
...
/////////////////////////////////////////////////////////////////////////////////
  ...
  .prop_ro("id",[](pyentity_ptr_t ent) -> uint64_t {
    return ent->_entref;
  })
  .prop_rw("translation",[](pyentity_ptr_t ent) -> fvec3 {
  ...
  .def("findComponentByName",[](pyentity_ptr_t ent, const std::string& classname) -> pycomponent_ptr_t {
    auto comp = ent->GetComponentByClassName(classname);
    auto wrapped = pycomponent_ptr_t(comp);
    return wrapped;
  })

  .def("__repr__", [](pyentity_ptr_t ent) -> std::string {
    return FormatString("ent<%p>", ent.get() );
  });
