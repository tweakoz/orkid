...
namespace ork::ecs {
///////////////////////////////////////////////////////////////////////////////
static logchannel_ptr_t logchan_sgcomp = logger()->configureChannel("ecs.sgcomp", fvec3(0.9, 0.7, 0));
///////////////////////////////////////////////////////////////////////////////
using namespace ork;
...
void SceneGraphNodeItemData::describeX(object::ObjectClass* clazz) {
  ...
  // layers=[...] declarations live here, NOT in LayerName — without this the
  // deserialized node fell to the unrendered sg_default layer (invisible).
...
void SceneGraphComponentData::describeX(ComponentDataClass* clazz) {
  ...
  clazz->directProperty("InstanceNodeName", &SceneGraphComponentData::_instanceNodeName);
}
///////////////////////////////////////////////////////////////////////////////
...
void_lambda_t SceneGraphComponent::_genTransformOperation() {
  return [=]() {
    ...
    auto ent_xf  = ent->_dagnode->_xfnode;
    ...
    for (auto NITEM : this->_nodeitems) {
      ...
      if (node) {
        ...
        if (ovxf) {
          ...
          auto xform = ent_xf->_transform;
          auto pos = xform->_translation;
          //_dagnode->_xfnode->_transform
          //printf( "sgc xf<%p> exfpos<%g %g %g> xfn<%s>\n", (void*) xform.get(), pos.x, pos.y, pos.z, ent_xf->_name.c_str() );
