  ...
  for (auto item : impl->_deserialized) {
    ...
    /////////////////////////////////////////////////////////////////
      ...
      auto op           = [=]() {
        ...
        printf("FINDSYS ID<%llx> TRID<%llx>\n", (ull)ID, (ull)value._sysref._sysID);
    ...
    /////////////////////////////////////////////////////////////////
      ...
      auto op           = [=]() {
        ...
        printf("FINDCOMP ID<%llu> TRID<%llu>\n", (ull)ID, (ull)value._compref._compID);
    ...
    /////////////////////////////////////////////////////////////////
      ...
      auto op           = [=]() {
        ...
        printf("SYSREQ ID<%llu> TRID<%llu>\n", (ull)objID, (ull)value._respref._responseID);
