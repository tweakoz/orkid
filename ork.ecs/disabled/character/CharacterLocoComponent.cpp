...
private:
  ...
  CreateForceControllerInst(const BulletObjectComponentData& data, ork::ent::Entity* pent) const final;
...
struct LocomotionForceInst : public BulletObjectForceControllerInst {
  ...
  void UpdateForces(ork::ent::Simulation* inst, BulletObjectComponent* boci) final;
...
BulletObjectForceControllerInst*
LocomotionForceData::CreateForceControllerInst(const BulletObjectComponentData& data, ork::ent::Entity* pent) const {
...
///////////////////////////////////////////////////////////////////////////////
void LocomotionForceInst::UpdateForces(ork::ent::Simulation* inst, BulletObjectComponent* boci) { // final
...
class CharacterLocoComponent : public ComponentInst {
  ...
  bool DoLink(ork::ent::Simulation* psi) final {
    ...
    _boci = _entity->GetTypedComponent<BulletObjectComponent>();
    return true;
  }
