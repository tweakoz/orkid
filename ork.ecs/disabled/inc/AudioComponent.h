...
public:
  void SetAECD(const AudioEffectComponentData* aecd) {
    mData = aecd;
  }
  const AudioEffectComponentData* GetData() const {
    return mData;
  }
  int GetMutexPriority() const {
    return miMutexPriority;
  }
  const ork::PoolString& GetMutexGroup() const {
    return mMutexGroup;
  }
  const ork::PoolString& GetSubMixGroup() const {
    return mSubMixGroup;
  }
  float GetMaxEmitterDist() const {
    return mMaxEmitterDist;
  }
  bool IsEmitter() const {
    return mbEmitter;
  }
  const ork::MultiCurve1D& GetAttenuationCurve() const {
    return mAttenuationCurve;
  }
...
public:
  ...
  const ork::PoolString& GetBankName() const {
    return mBankName;
  }
  const ork::PoolString& GetProgramName() const {
    return mProgramName;
  }
  int GetNote() const {
    return miNote;
...
public:
  ...
  const ork::lev2::AudioGraph& GetTemplate() const {
    return mControlGraph;
  }
  ork::Object* TemplateAccessor() {
    return &mControlGraph;
  }
...
public:
  ...
  const AudioMultiEffectPlayDataItemBase& GetData() const {
    return mItemBaseData;
  }
...
public:
  ...
  const ork::orklut<ork::PoolString, AudioMultiEffectPlayDataItemBase*>& GetSubSoundMap() const {
    return mSubSoundMap;
  }
  EMultiSoundSelectMode GetSelectMode() const {
    return mSelectMode;
  }
...
public:
  const ork::lev2::AudioIntrumentPlayParam& GetParams() const {
    return mParam;
  }
  ork::lev2::AudioIntrumentPlayParam& GetParams() {
    return mParam;
  }
  ...
  const AudioMultiEffectPlayData& GetData() const {
    return mData;
  }
  ...
  const ork::orklut<ork::PoolString, AudioMultiEffectPlayInstItemBase*>& GetSubSoundMap() const {
    return mSubSoundMap;
  }
...
public:
  ...
  const ork::orklut<ork::PoolString, ork::lev2::AudioBank*>& GetBankMap() const {
    return mBankMap;
  }
  const ork::orklut<ork::PoolString, AudioEffectPlayDataBase*>& GetSoundMap() const {
    return mSoundMap;
  }
  const ork::PoolString& GetMutexGroups() const {
    return mMutexGroups;
  }
...
public:
  ...
  ork::ent::DataflowRecieverComponentInst* GetDflowReciver() const {
    return mDflowRecv;
  }
...
public:
  ...
  const AudioStreamComponentData& GetData() const {
    return mData;
  }
...
class AudioSystemData final : public ork::ent::SystemData {
...
public:
  ...
  AudioSystemData();
  ///////////////////////////////////////////////////////
  const ork::lev2::AudioReverbProperties& GetReverbProperties() const {
    return mReverbProperties;
  }
  ...
  float GetDistScale() const {
    return mfDistScale;
  }
  float GetDistAttenPower() const {
    return mfDistAttenPower;
  }

private:
  ork::ent::System* createSystem(ork::ent::Simulation* pinst) const override;

  ork::Object* ReverbAccessor() {
    return &mReverbProperties;
  }
...
class AudioSystem final : public ork::ent::System {
...
public:
  ...
  void AddEmitter(AudioEffectComponentInst* mEmitter) {
    mEmitters.push_back(mEmitter);
  }

  const AudioSystemData& GetAmcd() const {
    return mAmcd;
  }
...
private:
  ...
  void DoStop(ork::ent::Simulation* psi) override;
