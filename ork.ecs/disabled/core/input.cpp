...
svar64_t InputComponent::doQuery(const ComponentQuery& q) {
  ...
  if (q._eventID == "get.group") {
    ...
    auto grp     = lev2::InputManager::instance()->inputGroup(grpname);
    //////////////////////////////////
    // todo USE OpaqueWrapper HERE
    //////////////////////////////////
    rval.Set<void*>(grp.get());
...
void InputSystem::DoUpdate(Simulation* psi) {
  lev2::InputManager::instance()->poll();
}
///////////////////////////////////////////////////////////////////////////////
} // namespace ork::ent
